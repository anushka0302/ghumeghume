...
const Terms = () => {
  ...
  return (
    <>
      {/* ✅ SEO Metadata */}
      <Helmet>
        <title>Terms and Conditions | Ghume Ghume</title>
        <meta name="description" content="Read our terms and conditions regarding booking, payments, and user responsibilities for trekking with Ghume Ghume." />
      </Helmet>
