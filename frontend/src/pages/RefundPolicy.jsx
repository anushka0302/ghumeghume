...
const RefundPolicy = () => {
  ...
  return (
    <>
      {/* ✅ SEO Metadata */}
      <Helmet>
        <title>Cancellation & Refund Policy | Ghume Ghume</title>
        <meta name="description" content="Read our cancellation and refund policy. Learn about deduction charges, refund timelines, and credit notes for force majeure events." />
      </Helmet>
